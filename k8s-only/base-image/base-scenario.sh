...
scriptsDir="/home/root/ballerina-performance-cloud/tests/"$scenario_name"/scripts"
resultsDir="/home/root/ballerina-performance-cloud/tests/"$scenario_name"/results"