...
export PATH=$PATH:/home/root/apache-jmeter-5.4/bin/
echo 'export PATH=$PATH:/home/root/apache-jmeter-5.4/bin/' |  tee -a /etc/profile.d/10-perf-vm.sh
echo "JVM_ARGS=\"-XX:InitialRAMPercentage=25.0 -XX:MaxRAMPercentage=75.0 -Dnashorn.args=--no-deprecation-warning\"" |  tee -a /home/root/apache-jmeter-5.4/bin/setenv.sh